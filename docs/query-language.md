...
The query language allows you to filter tasks using natural language syntax similar to Obsidian Tasks. Each query can contain multiple instructions, one per line:
